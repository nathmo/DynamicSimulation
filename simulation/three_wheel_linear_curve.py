...
class RobotThreeWheelLinearCurve(RobotScenario):
    def load(self):
        ...
        spring_params = {
            'hipFL_to_legFL': (20, 1000.0, 0.15, 50000),
            'hipFR_to_legFR': (20, 1000.0, 0, 50000),
            'legFL_to_feetFL': (2.0, 100.0, 0, 50000),
            'legFR_to_feetFR': (2.0, 100.0, 0, 50000),
        }

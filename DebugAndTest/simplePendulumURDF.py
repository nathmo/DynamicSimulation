...
robot0000 = p.loadURDF("DebugAndTest/links0000.urdf", [1.0, 1.0, 1.25], useFixedBase=True)
robot9999 = p.loadURDF("DebugAndTest/pendulum.urdf", [0.0, 0.0, 1.25], useFixedBase=True)
